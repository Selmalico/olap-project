...
export default function ChatInterface({ onResult, loading, setLoading }) {
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hello! I'm your BI analyst. Ask me anything about your analytics data — I'll route your question through our specialist agents.",
    },
  ]);
  ...
  const send = async (query) => {
    ...
    try {
      ...
      const llmNote = data.llm_used
        ? ""
        : data.llm_fallback_reason
          ? ` *(${data.llm_fallback_reason})*`
          : " *(keyword routing — add OPENAI_API_KEY in backend/.env for full AI)*";
